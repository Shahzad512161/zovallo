      ...
      `}>
        <div className="p-8 flex flex-col h-full">
          <div className="flex items-center justify-between mb-12">
            <Link to="/" className="text-xl font-display tracking-tighter hover:text-gold transition-colors">ETHEREAL <span className="text-[10px] tracking-widest font-sans font-bold bg-gold px-2 py-0.5 rounded ml-2">ADMIN</span></Link>
          ...
          <div className="mt-auto pt-8 border-t border-white/10">
            <div className="flex items-center gap-3 px-4 py-3 mb-6">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs font-bold truncate">{profile?.displayName || 'Admin'}</p>
                <p className="text-[10px] text-gray-400 truncateCapitalize">{profile?.email}</p>
              </div>
            </div>
            <button 
        ...
        <header className="bg-white h-20 border-b border-warm-beige px-6 sm:px-10 flex items-center justify-between sticky top-0 z-30">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-right hidden sm:block">
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">Session ID</p>
              <p className="text-xs font-mono text-walnut font-bold">#ADM-8234-91</p>
            </div>
          </div>
        </header>
