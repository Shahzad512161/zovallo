  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-16 px-4 space-y-6 max-w-md mx-auto">
      ...
      <div className="space-y-2">
        <h3 className="text-xl font-display text-near-black uppercase tracking-tight">{title}</h3>
        <p className="text-sm text-gray-666 font-light leading-relaxed">{description}</p>
      </div>
