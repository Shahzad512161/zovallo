...
import { Mail, Phone, MapPin, Clock, Send, CheckCircle, MessageSquare, Facebook, Instagram, Twitter, AlertCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16">
          ...
          <p className="text-gray-500 mt-4 text-sm sm:text-base max-w-2xl mx-auto">
            Have questions? We'd love to hear from you. Our team is here to assist you with any inquiries.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-cream/30 p-6 rounded-lg">
              <h2 className="text-xl font-display text-near-black mb-6">Get in Touch</h2>
              
              <div className="space-y-5">
                <div className="flex gap-4 items-start">
                  <MapPin className="w-5 h-5 text-gold mt-0.5" />
                  <div>
                    <h3 className="font-bold text-near-black text-sm">Visit Us</h3>
                    <p className="text-gray-666 text-sm">LUXWOOD Furniture, 123 Design Street,<br />London, United Kingdom, SW1A 1AA</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-near-black text-sm">Call Us</h3>
                    <p className="text-gray-666 text-sm">+44 20 1234 5678</p>
                    <p className="text-gray-500 text-xs">Mon-Fri, 9 AM - 6 PM GMT</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-near-black text-sm">Email Us</h3>
                    <p className="text-gray-666 text-sm">support@luxwood.com</p>
                    <p className="text-gray-500 text-xs">Sales: sales@luxwood.com</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-near-black text-sm">Business Hours</h3>
                    <p className="text-gray-666 text-sm">Monday - Friday: 9 AM - 6 PM</p>
                    <p className="text-gray-666 text-sm">Saturday: 10 AM - 4 PM</p>
            ...
            <div className="bg-white border border-warm-beige p-6 rounded-lg text-center">
              ...
              <div className="flex justify-center gap-4">
                <a href="#" className="p-2 bg-cream rounded-full hover:bg-gold transition-colors group">
              ...
              <p className="text-xs text-gray-500 mt-4">Stay updated with our latest collections and offers</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white border border-warm-beige p-6 sm:p-8 rounded-lg">
              <h2 className="text-xl font-display text-near-black mb-6">Send Us a Message</h2>
        ...
        <div className="mt-16 pt-8 border-t border-warm-beige">
          <h2 className="text-2xl font-display text-near-black text-center mb-8">Frequently Asked Questions</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <h3 className="font-bold text-near-black">Do you offer free delivery?</h3>
              <p className="text-gray-666 text-sm">Yes! We offer free standard delivery across the United Kingdom on all orders.</p>
            </div>
            <div className="space-y-2">
              <h3 className="font-bold text-near-black">Can I inspect before paying?</h3>
              <p className="text-gray-666 text-sm">Absolutely! With our Cash on Delivery option, you can inspect your furniture before making payment.</p>
            </div>
            <div className="space-y-2">
              <h3 className="font-bold text-near-black">What is your return policy?</h3>
              <p className="text-gray-666 text-sm">We offer a 14-day return policy. Contact our support team to initiate a return.</p>
            </div>
            <div className="space-y-2">
              <h3 className="font-bold text-near-black">How long does delivery take?</h3>
              <p className="text-gray-666 text-sm">UK delivery: 1-3 days. International delivery to Europe: 3-5 days, Canada: 5-7 days.</p>
            </div>
          </div>
        </div>
      </div>
