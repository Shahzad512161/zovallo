...
export default function UserProfile() {
  ...
  const printOrder = () => {
    ...
    const printContent = `
      ...
      <html>
      <head>
        <title>Order #${selectedOrder.id.slice(-8).toUpperCase()}</title>
        <style>
          @media print {
      ...
      <body>
        <div class="invoice-container">
          ...
          <div class="totals">
            <p><strong>Subtotal:</strong> ${formatCurrency(selectedOrder.totalPrice)}</p>
            <p><strong>Delivery:</strong> FREE</p>
            <p class="grand-total"><strong>GRAND TOTAL:</strong> ${formatCurrency(selectedOrder.totalPrice)}</p>
          </div>
          <div class="footer">
  ...
  const getInvoiceHTML = () => {
    ...
    <head>
      <style>
        ...
        .logo span { color: #c1a57b; }
        .info-section { display: flex; justify-content: space-between; margin-bottom: 20px; background: #f5f5f2; padding: 15px; }
        .info-box { flex: 1; }
    ...
    <body>
      ...
      <div class="info-section">
        <div class="info-box">
          <h3>ORDER DETAILS</h3>
          <p><strong>Order #:</strong> ${selectedOrder.id.slice(-8).toUpperCase()}</p>
          <p><strong>Date:</strong> ${selectedOrder.createdAt?.toDate().toLocaleDateString()}</p>
      ...
      <div class="totals">
        <p><strong>Subtotal:</strong> ${formatCurrency(selectedOrder.totalPrice)}</p>
        <p><strong>Delivery:</strong> FREE</p>
        <div class="grand-total"><strong>GRAND TOTAL:</strong> ${formatCurrency(selectedOrder.totalPrice)}</div>
      </div>
      
      <div class="footer">
        <p>Payment: Cash on Delivery | Thank you for shopping with LUXWOOD!</p>
      </div>
    </body>
    </html>
  `;
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <aside className="lg:w-80 space-y-6">
          <div className="bg-white border border-warm-beige rounded-lg p-6 text-center">
