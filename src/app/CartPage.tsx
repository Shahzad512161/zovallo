      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-1 space-y-8">
          <div className="flex items-center justify-between border-b border-warm-beige pb-6">
            <h1 className="text-3xl font-display text-near-black">Shopping Cart</h1>
            <Link to="/shop" className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-walnut hover:text-near-black transition-colors group">
        ...
        <aside className="w-full lg:w-[380px] space-y-6">
          <div className="bg-cream/30 border border-warm-beige p-8 sticky top-44">
            <h2 className="text-xl font-display text-near-black mb-6">Order Summary</h2>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="pt-4 border-t border-warm-beige flex justify-between items-baseline">
                <span className="text-lg font-display text-near-black">Total</span>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-4 py-6 border-t border-warm-beige mt-6">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-[10px] font-bold uppercase tracking-widest text-gray-666">Secure Checkout Guaranteed</p>
                </div>
                <div className="flex items-center gap-3">
                  <Truck className="w-5 h-5 text-mint-700" />
                  <p className="text-[10px] font-bold uppercase tracking-widest text-gray-666">White Glove Delivery available</p>
                </div>
              </div>
            </div>
          </div>
