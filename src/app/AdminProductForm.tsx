  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] space-y-4">
        <LoadingSpinner />
        <div className="text-xs font-bold uppercase tracking-widest text-gold animate-pulse">
    ...
    <div className="max-w-5xl mx-auto space-y-8 sm:space-y-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-warm-beige pb-8 gap-6">
        <div className="flex items-center gap-4 sm:gap-6">
          <Link
            to="/admin/products"
            className="p-3 bg-white border border-warm-beige hover:bg-gold hover:text-white transition-colors block shrink-0"
          >
        ...
        <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-gray-400">
          Admin <ChevronRight className="w-3 h-3" /> Inventory{" "}
          <ChevronRight className="w-3 h-3" /> {isEdit ? "Edit" : "New"}
        </div>
      </div>
        ...
        <div className="lg:col-span-2 space-y-8 sm:space-y-12">
          ...
          <section className="bg-white border border-warm-beige p-6 sm:p-10 space-y-8 shadow-sm">
            <div className="flex items-center gap-3 border-l-4 border-gold pl-4">
              ...
              <h2 className="text-base sm:text-lg font-display text-near-black uppercase">
                Core Identity
              </h2>
            </div>
        ...
        <aside className="space-y-8">
          <div className="bg-near-black text-white p-6 sm:p-10 space-y-8 sticky top-44">
            <div className="flex items-center gap-3 border-l-4 border-gold pl-4">
              ...
              <h2 className="text-base sm:text-lg font-display uppercase">
                Commercial Intel
              </h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded">
                ...
                >
                  <div
                    className={`w-4 h-4 bg-white rounded-full transition-transform duration-300 ${formData.featured ? "translate-x-6" : "translate-x-0"}`}
                  />
                </button>
              </div>
