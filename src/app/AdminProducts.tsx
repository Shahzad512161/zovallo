          ...
          <table className="w-full">
            <thead>
              <tr className="bg-cream/50">
                <th className="px-8 py-5 text-left text-[10px] font-bold uppercase tracking-widest text-gray-400">
                  Product
                </th>
                <th className="px-8 py-5 text-left text-[10px] font-bold uppercase tracking-widest text-gray-400">
                  Category
            ...
            <tbody className="divide-y divide-warm-beige">
              {loading ? (
                ...
                <tr>
                  <td
                    colSpan={5}
                    className="px-8 py-12 text-center text-gray-400 text-sm"
                  >
                  ...
                  >
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                          <span className="text-sm font-bold text-near-black mb-0.5 line-clamp-1">
                            {p.title}
                          </span>
                    ...
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-widest text-walnut">
                          {p.category}
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="px-8 py-6">
                      <div className="flex flex-col gap-1.5">
                        ...
                        <span
                          className={`text-[10px] font-bold uppercase ${p.stock < 5 ? "text-red-500" : "text-mint-700"}`}
                        >
                          {p.stock} Available
                        </span>
                      </div>
