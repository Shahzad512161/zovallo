                    ...
                    <tr>
                      <td colSpan={5} className="px-6 py-24">
                        <div className="flex flex-col items-center justify-center gap-4">
                          <LoadingSpinner />
                          <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-gold text-center">
                            Scanning ledger...
                          </p>
                        </div>
                      </td>
            ...
            <div className="bg-white border border-warm-beige p-8 sticky top-44 space-y-10">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-display font-bold text-near-black">
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-4 max-h-48 overflow-y-auto pr-2">
                    {selectedOrder.products.map((p, idx) => (
                      <div key={idx} className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <p className="text-xs font-bold text-near-black leading-tight truncate">
                            {p.title}
                          </p>
                ...
                <div className="p-6 bg-near-black text-white space-y-4">
                  ...
                  <div className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-widest text-mint-400">
                    <CheckCircle className="w-3.5 h-3.5" /> Paid via Cash on
                    Delivery
                  </div>
                </div>
              </div>
