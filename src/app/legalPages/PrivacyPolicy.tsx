...
import { Shield, Lock, Eye, Database, Mail, Cookie, ShieldCheck, Package } from 'lucide-react';
        ...
        <div className="space-y-8 sm:space-y-10 md:space-y-12">
          ...
          <section className="bg-cream/30 p-6 sm:p-8 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-display text-near-black">Our Commitment to Privacy</h2>
            </div>
            <p className="text-gray-666 leading-relaxed">
              At LUXWOOD, we are committed to protecting your personal information and your right to privacy. 
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-display text-near-black mb-4">Information We Collect</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-bold text-near-black mb-2">Personal Information</h3>
                <ul className="list-disc list-inside space-y-1 text-gray-666 text-sm">
                  ...
                  <li>Payment information (processed securely via encrypted payment gateways)</li>
                  <li>Order history and preferences</li>
                  <li>Communications with our support team</li>
                </ul>
              </div>
              <div>
                <h3 className="font-bold text-near-black mb-2">Automatically Collected Information</h3>
                <ul className="list-disc list-inside space-y-1 text-gray-666 text-sm">
          ...
          <section>
            <h2 className="text-xl sm:text-2xl font-display text-near-black mb-4">How We Use Your Information</h2>
            <div className="grid sm:grid-cols-2 gap-4">
              <div className="flex gap-3 items-start p-4 border border-warm-beige rounded-lg">
                ...
                <div>
                  <h3 className="font-bold text-near-black text-sm">Process Orders</h3>
                  <p className="text-gray-666 text-xs">Manage your purchases and deliveries</p>
                </div>
              </div>
              <div className="flex gap-3 items-start p-4 border border-warm-beige rounded-lg">
                <Mail className="w-5 h-5 text-gold mt-0.5" />
                <div>
                  <h3 className="font-bold text-near-black text-sm">Send Updates</h3>
                  <p className="text-gray-666 text-xs">Order confirmations and shipping notifications</p>
                </div>
              </div>
              <div className="flex gap-3 items-start p-4 border border-warm-beige rounded-lg">
                <ShieldCheck className="w-5 h-5 text-gold mt-0.5" />
                <div>
                  <h3 className="font-bold text-near-black text-sm">Prevent Fraud</h3>
                  <p className="text-gray-666 text-xs">Protect against unauthorized transactions</p>
                </div>
              </div>
              <div className="flex gap-3 items-start p-4 border border-warm-beige rounded-lg">
                <Eye className="w-5 h-5 text-gold mt-0.5" />
                <div>
                  <h3 className="font-bold text-near-black text-sm">Improve Experience</h3>
                  <p className="text-gray-666 text-xs">Personalize your shopping experience</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="bg-mint-50 p-6 sm:p-8 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-display text-near-black">Data Security</h2>
            </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-xl sm:text-2xl font-display text-near-black">Cookies</h2>
            </div>
            ...
            <div className="bg-cream/30 p-4 rounded-lg text-sm text-gray-600">
              <strong>Types of cookies we use:</strong> Essential cookies (required for website functionality), 
              Analytics cookies (to understand how visitors use our site), and Preference cookies (to remember your settings).
            </div>
          </section>

          {/* Your Rights */}
          <section>
            <h2 className="text-xl sm:text-2xl font-display text-near-black mb-4">Your Privacy Rights</h2>
          ...
          {/* Contact */}
          <section className="bg-cream/30 p-6 sm:p-8 rounded-lg">
            <h2 className="text-xl sm:text-2xl font-display text-near-black mb-4">Contact Us</h2>
            <p className="text-gray-666 mb-3">
