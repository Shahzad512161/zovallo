...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      "Luxurious velvet sofa set with walnut wood legs. Perfect for modern living rooms. This premium set includes a 3-seater sofa and two matching armchairs, all upholstered in ultra-soft, stain-resistant velvet.",
    price: 1299.99,
    category: "Sofa Sets",
    images: [
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Absolutely stunning sofa set. The blue is even more vibrant in person!",
        date: "2024-03-10",
      },
      {
        id: "r2",
        ...
        rating: 4,
        comment:
          "Very comfortable and looks very high-end. Assembly was a bit tricky but worth it.",
        date: "2024-02-15",
      },
    ],
  },
  {
    ...
    description:
      "A spacious gray sectional sofa with deep seating and performance fabric.",
    price: 1899.0,
    category: "Sofa Sets",
    images: [
      "https://images.unsplash.com/photo-1493663284031-b7e3aefcae8e?auto=format&fit=crop&q=80&w=800",
  ...
  },
  {
    ...
    description:
      "Solid oak dining table with a minimalist design. Comfortably seats six.",
    price: 849.99,
  ...
  },
  {
    ...
    category: "Dining Tables",
    images: [
      "https://images.unsplash.com/photo-1530018607912-eff2ec1adab0?auto=format&fit=crop&q=80&w=800",
    ],
    stock: 4,
    featured: false,
    specifications: {},
  ...
  },
  {
    ...
    description:
      "Elegant upholstered bed frame with a high headboard and linen finish.",
    price: 999.0,
    category: "Beds",
    images: [
  ...
  },
  {
    ...
    description:
      "Mid-century modern bed frame crafted from sustainably sourced walnut.",
    price: 1200.0,
    category: "Beds",
    images: [
  ...
  },
  {
    ...
    description:
      "High-density memory foam mattress with cooling technology. Size: King.",
    price: 599.99,
    category: "Mattresses",
    images: [
  ...
  },
  {
    ...
    description:
      "Natural oak wood slat panels for superior sound absorption and style.",
    price: 159.0,
  ...
  },
  {
    ...
    description:
      "Adjustable lumbar support and breathable mesh. Ideal for home offices.",
    price: 249.99,
  ...
  },
  {
    ...
    description:
      "Extra large wardrobe with soft-close doors and integrated LED lighting.",
    price: 1100.0,
    category: "Wardrobes",
    images: [
